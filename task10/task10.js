...
// 3. Напишіть функцію mul(), яка приймає будь-яку кількість параметрів різного типу і повертає добуток 
// параметрів типу Number.
// Якщо параметри типу Number відсутні, повертає число 0.
// function mul(/* ваш код */...params) {
//    // Ваш код
//    let product = 1;
//    let arr = [...params]
//              .filter(item => typeof item === 'number')//method creates a new array filled with elements that pass a test provided by a function
//              .map(item => (product*=item))//creates a new array from calling a function for every array element.
//              .length;
...
// Використовуючи ці масиви, функція повинна створювати об'єкт типу Map, ключами якого є значення з 
// першого масиву, а значеннями Map - значення з другого масиву. Після цього функція повертає даний 
// об'єкт Map.
...
//First option with using outside function
var arr = [];
for (var i = 0; i <= 2; i++) {
    arr[i] = function () {
        console.log(i);
...
// //()=>{this} chamnges (function(){}).bind(this) 
